				...
				<div class="col-md-12">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/tabs-pro-plugin/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_test_b_directory_url.'assets/images/tabs-pro.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/service-showcase-pro-plugin-wordpress/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_test_b_directory_url.'assets/images/service-pro.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
						<a href="https://wpshopmart.com/plugins/counter-numbers-pro/" target="_blank" title="Accordion Pro">
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_test_b_directory_url.'assets/images/counters.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
