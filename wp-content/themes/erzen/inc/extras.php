...
function erzen_display_upgrade() {
  $theme_data = wp_get_theme('erzen'); 
    ...
    $rating_url = 'https://wordpress.org/support/theme/erzen/reviews/?filter=5';  
            ...
            <div class="theme_info info-tab-content">
                <div class="theme_info_column clearfix">
                    <div class="theme_info_left">
						...
						<div class="theme_link">
                            <h3><?php esc_html_e( 'Please Rate Us', 'erzen' ); ?></h3>
                            <p class="about"><?php printf(esc_html__('We need your help to expand or and portoflio so please rate us on wordpress ', 'erzen'), $theme_data->Name); ?></p>
                            <p>  
                                <a href="<?php echo esc_url($rating_url); ?>" target="_blank" class="button button-secondary"><?php echo sprintf( esc_html('Rate This Theme', 'erzen'), $theme_data->Name); ?></a>
                            </p>
                        </div> 	
