...
function get_custom_logo( $blog_id = 0 ) {
	...
	if ( $custom_logo_id ) {
		 ...
		 */
		$html = sprintf('<a rel="home" href="' . esc_url( home_url( '/' ) ) . '">'
		                .'<h1 rel="home" class="site-title" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '">'
		                .'%2$s'
		                . esc_html( get_bloginfo( 'name' ) ) . '</h1>'
//		                .'<h2 class="site-description" title="' . esc_attr( get_bloginfo( 'description', 'display' ) ) . '">' . esc_html( get_bloginfo( 'description' ) ) . '</h2>'
		                .'</a>'
		                 ,
			esc_url( home_url( '/' ) ),
